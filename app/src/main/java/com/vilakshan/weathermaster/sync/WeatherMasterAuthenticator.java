...
/**
 * Manages "Authentication" to Weather Master backend service.  The SyncAdapter framework
 ...
 */
class WeatherMasterAuthenticator extends AbstractAccountAuthenticator {

    WeatherMasterAuthenticator(Context context) {
        super(context);
    }
