...
public class WeatherContract {
    ...
    // device.
    static final String CONTENT_AUTHORITY = "com.vilakshan.weathermaster";
    ...
    public static final class WeatherEntry implements BaseColumns {
        ...
        // Icon name of weather to determine day or night
        ...
        public static Uri buildWeatherLocation(String locationSetting) {
            Uri uri = CONTENT_URI;
            uri = uri.buildUpon().appendPath(locationSetting).build();
            return uri;
        }
