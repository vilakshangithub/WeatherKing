...
import com.vilakshan.weathermaster.data.WeatherContract.LocationEntry;
import com.vilakshan.weathermaster.data.WeatherContract.WeatherEntry;
...
class WeatherDbHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase sqLiteDatabase) {
        ...
        final String SQL_CREATE_WEATHER_TABLE = "CREATE TABLE " + WeatherEntry.TABLE_NAME + " (" +
                ...
                WeatherEntry.COLUMN_ICON_NAME + " TEXT NOT NULL, " +
